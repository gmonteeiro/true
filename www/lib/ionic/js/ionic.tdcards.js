          ...
          var swipeableCard = new SwipeableCardView({
            ...
            onSnapBack: function(startX, startY, startRotation) {
              ...
              .on('step', function(v) {
                ...
                // rightText.style.opacity = Math.max(v * (1-rightText.style.opacity), 0);
                // leftText.style.opacity = Math.max(v * (1-leftText.style.opacity), 0);
              })
              .start();
              /*
      ...
      controller: function($scope, $element) {
        ...
        var sortCards = function() {
          ...
          for(i = 0; i < existingCards.length; i++) {
            ...
            card.style.width = (95 - i)+'%';
            card.style.marginLeft = (-(95-i)/2)+'%';
          }
        };
